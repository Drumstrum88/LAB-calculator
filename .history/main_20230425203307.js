...
// This is my function for the actual math of the calculator. I used the parseFloat method to tell the computer that my strings are really numbers and performs 
const calculate = () => {
